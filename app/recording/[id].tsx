...
const styles = StyleSheet.create({
  ...
  muted: { color: Colors.secondary, fontSize: 14 },
  ...
  meta: { fontSize: 14, color: Colors.secondary, marginBottom: 18 },
  statusCard: {
    backgroundColor: Colors.card, borderRadius: 13, padding: 13,
    marginBottom: 16,
  },
  statusRow: { flexDirection: 'row', alignItems: 'center', gap: 8 },
  statusText: { fontSize: 14, color: Colors.label, fontWeight: '500' },
  actionButton: {
